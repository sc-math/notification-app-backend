...
public class DeviceController {
    ...
    // Method Get
    @GetMapping("/ativos")
    public ResponseEntity<?> countActiveDevice(@RequestParam int limit){
        log.info("GET /devices - Contando dispositivos ativos com menos de {} dias", limit);
        long response = deviceService.countActiveDevice(limit);
